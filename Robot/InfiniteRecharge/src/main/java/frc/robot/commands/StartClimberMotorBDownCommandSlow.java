...
public class StartClimberMotorBDownCommandSlow extends CommandBase {
  @SuppressWarnings({ "PMD.UnusedPrivateField", "PMD.SingularField" })

  private final Logger logger = Logger.getLogger(this.getClass().getName());
  int time = 0;

  public StartClimberMotorBDownCommandSlow() {
  ...
  public void initialize() {
    ...
    RobotContainer.getInstance().Climber.SpinMotorBDownSlow();
  }
