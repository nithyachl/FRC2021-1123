...
public class StartClimberMotorADownCommandSlow extends CommandBase {
  @SuppressWarnings({ "PMD.UnusedPrivateField", "PMD.SingularField" })

  private final Logger logger = Logger.getLogger(this.getClass().getName());
  int time = 0;

  public StartClimberMotorADownCommandSlow() {
  ...
  public void initialize() {
    ...
    RobotContainer.getInstance().Climber.SpinMotorADownSlow();
  }
