 ...
 *
 */
public class RGBSensorSubsystem extends SubsystemBase{
    ...
    public void periodic() {
      ...
      SmartDashboard.putNumber("Read Colors", good);

      SmartDashboard.putNumber("Red Val", getRedVal());
      SmartDashboard.putNumber("Green Val", getGreenVal());
      SmartDashboard.putNumber("Blue Val", getBlueVal());
    }
